export default function DataNotAvailableTemplate({ headerText, descriptionText }: { headerText: string; descriptionText?: string }) {
    return (
        <>
            <div className="relative">
                ...
                <div className="absolute inset-x-0 bottom-0 flex h-32 flex-col items-center justify-center bg-gradient-to-t from-white to-transparent dark:from-gray-950">
                    ...
                    {descriptionText && <p className="mt-2 text-tremor-default text-tremor-content dark:text-dark-tremor-content">
                        {descriptionText}
                    </p>}
                </div>
            </div>
