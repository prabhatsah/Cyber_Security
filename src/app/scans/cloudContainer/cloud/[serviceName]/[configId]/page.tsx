<<<<<<< HEAD:src/app/scans/cloudContainer/cloud/[serviceName]/[dashboard]/page.tsx
      ...
      computeengine: {
        resources: {
          ...
          forwarding_rules: {
            ...
            script: "services.computeengine.projects.regions.forwarding_rules",
          },
      ...
      cloudmemorystore: {
        resources: {
          redis_instances: {
            cols: 2,
            count: 0,
            full_path: "services.cloudmemorystore.projects.id.redis_instances",
  ...
  return (
    <div className="dashboard-container">
      ...
      {Object.entries(services).map(([serviceName, serviceData]) => {
        // Transform data for the two tables.
        const countData = transformCountsToArray(serviceData);
        const findingsData = transformFindingsToArray(serviceData);

        return (
          <div key={serviceName} className="service-section">
            <h2 className="service-title">{serviceName.toUpperCase()}</h2>

            {/* Resource Counts DataTable */}
            {countData.length > 0 && (
...
>>>>>>> e17f880f188189eed3785bd6cc37a99a9e27cd46:src/app/scans/cloudContainer/cloud/[serviceName]/[configId]/page.tsx
