...
const WorkflowComponent = ({ items, pipelineActionBtns }: { items: Items[], pipelineActionBtns: WorkflowActionBtns[] }) => {
            ...
            <div className="flex items-center">
              ...
              {item.dropdown && <DropdownMenu>
                ...
                <DropdownMenuContent align="start">
                  <DropdownMenuGroup>
                    {pipelineActionBtns && pipelineActionBtns.map((option, ind) => (
                      <DropdownMenuItem key={ind} onClick={async () => {
                        option.btnFn()
                      }}>
                        {option.btnIcon}
