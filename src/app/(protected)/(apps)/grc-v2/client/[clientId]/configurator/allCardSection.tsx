...
export default function CardPage({ riskCategoryData, riskImpactData, taskFrequencyData, profileData, clientId }: { riskCategoryData: Record<string, string>[], riskImpactData: Record<string, string>[]; taskFrequencyData: Record<string, string>[]; profileData: Record<string, string>[]; clientId: string }) {
    ...
    return (
            ...
            <div className="flex flex-row gap-8">
                {/* <Card className="w-[380px]">
                    ...
                    <CardFooter className="flex justify-end space-x-2">
                        <Button onClick={handleViewCategory} variant="outline">View</Button>
                        <Button onClick={handleEditCategory}>Edit</Button>
                    </CardFooter>
                </Card> */}
                {/* <Card className="w-[380px]">
                    <CardHeader>
                        <CardTitle>Risk Impact</CardTitle>
                        <CardDescription>
                            Risk Category refers to the classification of potential risks based on their nature, source, or impact.
                            This helps in organizing and analyzing risks more effectively.
                        </CardDescription>
                    ...
                    <CardFooter className="flex justify-end space-x-2">
                        <Button onClick={handleViewImpact} variant="outline">View</Button>
                        <Button onClick={handleEditImpact}>Edit</Button>
                    </CardFooter>
                </Card> */}
      ...
      ">
                    {/* Subtle background gradient overlay for professionalism */}
                    <div className="absolute inset-0 bg-gradient-to-br from-zinc-800/20 to-transparent pointer-events-none"></div>

                    {/* Applying professional styling directly to the Shadcn CardHeader component */}
                    <CardHeader className="p-6 pb-4 relative z-10">
                        {/* Applying professional styling directly to the Shadcn CardTitle component */}
                        ...
                        {/* Applying professional styling directly to the Shadcn CardDescription component */}
                    ...
                    {/* Applying professional styling directly to the Shadcn CardContent component */}
                    <CardContent className="p-6 pt-0 relative z-10">

                    </CardContent>

                    {/* Applying professional styling directly to the Shadcn CardFooter component */}
                    <CardFooter className="flex justify-end space-x-3 p-6 pt-0 relative z-10">
                        {/* Applying professional styling directly to the Shadcn Button components */}
                        <Button
      ...
      ">
                    ...
                    <CardHeader className="p-6 pb-4 relative z-10">
                        ...
                        {/* Applying professional styling directly to the Shadcn CardDescription component */}
                        <CardDescription className="text-sm text-gray-400 mt-2 line-clamp-3">
                            Add your Task Frequency Anytime
                        </CardDescription>
                    </CardHeader>
