...
export default function TaskFrequncyEdit({ open, setOpen, taskFrquencyData, profileData }: { open: boolean; setOpen: React.Dispatch<React.SetStateAction<boolean>>; taskFrquencyData: Record<string, string>[]; profileData: Record<string, string>[] }) {
