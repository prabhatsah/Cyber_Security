...
export default function RiskCategoryEdit({ open, setOpen, riskCategoryData, profileData, clientId }: { open: boolean; setOpen: React.Dispatch<React.SetStateAction<boolean>>; riskCategoryData: Record<string, string>[]; profileData: Record<string, string>[]; clientId: string }) {
    ...
    useEffect(() => {
        ...
        // Flatten all riskImpact objects into a single array of riskImpact values
