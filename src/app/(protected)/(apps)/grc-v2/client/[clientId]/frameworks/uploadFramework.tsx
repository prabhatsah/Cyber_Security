...
export default function UploadFramework({ uploadDialogOpen, setUploadDialogOpen }: { uploadDialogOpen: boolean; setUploadDialogOpen: React.Dispatch<React.SetStateAction<boolean>>; }) {
    ...
    const handleUpload = async () => {
        ...
        reader.onload = async (e) => {
            try {
                ...
                // for (let i = 1501; i <= 1702; i++) {
                //     const row = jsonData[i] as { [key: string]: any };
