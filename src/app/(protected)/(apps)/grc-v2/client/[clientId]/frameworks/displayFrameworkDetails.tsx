...
import { NewFrameworkMainContext } from '../../../(openingPage)/new-components/context/newFrameworkContext';
export default function DisplayFrameworkDetails({
    ...
    const { allUsers,userId } = NewFrameworkMainContext();
    ...
    async function handleFrameworkSubscribe() {
        ...
        const finalData = {
            ...
            clientId: clientId,
            owner: owner,
            soaExists: showFrameworkDetails?.soaExists || false,
            responsibilityMatrixExists: showFrameworkDetails?.responsibilityMatrixExists || false,
            addedOn: new Date()
        };
        ...
        try {
            ...
            if(showFrameworkDetails?.responsibilityMatrixExists){
                ...
                await startProcessV2({
                    ...
                    data: {...showFrameworkDetails,clientId: clientId},
                    processIdentifierFields: "",
                })
            }
