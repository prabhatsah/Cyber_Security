...
export default function BauTab({ allUsers, groupedByTaskType, referencedPolicyMap,referenceDropDown, bauTaskFrequency, bauTaskFreqMap, customeControls, dropDownControl, clientId }:
    {
            ...
            items: [
                {
                    label: "Edit",
                    onClick: (rowData) => {
                        if (!rowData.clientId || rowData.referenceTaskId) {
                            const controls = []
