...
export default function Page() {
  ...
  return (
    ...
    <>
      <h1 className="text-2xl font-bold mb-2 text-foreground">Discovery</h1>
      <p className="mb-4 text-muted-foreground">
        Enables organizations to automatically identify and inventory assets, providing a foundation for effective governance, risk management, and compliance.
      </p>
      ...
      <DataTable columns={discoveryTableColumns} data={discoveryData} extraParams={ext} />
