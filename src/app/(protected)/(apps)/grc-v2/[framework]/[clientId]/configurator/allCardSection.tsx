...
export default function CardPage({ riskCategoryData, riskImpactData, controlObjectivesData, taskFrequencyData, profileData }: { riskCategoryData: Record<string, string>[], riskImpactData: Record<string, string>[]; controlObjectivesData: Record<string,string>[]; taskFrequencyData: Record<string, string>[]; profileData: Record<string, string>[]  }) {
