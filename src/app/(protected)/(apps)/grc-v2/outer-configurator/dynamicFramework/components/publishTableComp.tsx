...
import { ArrowDownCircle, ArrowRightCircle, Circle, Pencil } from 'lucide-react';
import { nestedData } from './frameworkStructure';
import SearchInput from '@/ikon/components/search-input';
import { Card } from '@/shadcn/ui/card';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/shadcn/ui/table';
import ViewFormInPublish from './viewFormInPublish';
const columnHelper = createColumnHelper<any>();

export default function PublishTableComp({
    frameworkStructureData,
    frameworkFieldConfigData
}: {
    frameworkStructureData: Record<string, string>[];
            ...
            header: ({ table }) =>
                index === 0 ? (
                    <div className="flex items-start gap-2">
                        ...
                        <span className='self-center capitalize'>{field.name}</span>
                    </div>
                ) : (
    ...
    return (
        <>
            ...
            <Card className="rounded-xl shadow p-4 h-[50vh] overflow-hidden flex flex-col">
            ...
            {
                updateRows && openUpdateDynamicForm && (
                    <ViewFormInPublish
                        frameworkFieldConfigData={frameworkFieldConfigData}
                        openViewPublishForm={openUpdateDynamicForm}
                        setOpenViewPublishForm={setOpenUpdateDynamicForm}
