...
export const AuditReportFormSchema = z.object({
    ...
    OBSERVATION: z
        .array(z.string().min(2, 'Observation is required'))
    ...
    SEVERITY: z.
        string()
        .min(2, { message: 'Severity must be at least 2 characters long.' })
        .trim(),
})
...
export const auditType = [
    { label: "Best Practice", value: 'bestPractice' },
    { label: "Standard", value: 'standard' },
    { label: "Rules and Regulation", value: 'regulation' },
]
...
export default function AuditEvaluationForm({ open, setOpen, editRow, updateRow, userMap }: { open: boolean, setOpen: React.Dispatch<React.SetStateAction<boolean>>, editRow: Record<string, string> | null, updateRow: Record<string, string> | null, userMap: userMapSchema }) {
    console.log(editRow)
    ...
    const form = useForm<z.infer<typeof AuditReportFormSchema>>({
        ...
        defaultValues: {
            ...
            CONTROL_OBJECTIVE: editRow ? editRow.controlObjectiveName : updateRow ? updateRow.controlObjectiveName : '',
            ...
            COMPLIANCE_STATUS: updateRow ? updateRow.complianceStatus : editRow ? editRow.complianceStatus : '',
            OBSERVATION: [' '],
            ...
            SEVERITY: editRow? editRow.severity : ''
        },
    });
    ...
    async function saveAuditReportForm(data: z.infer<typeof AuditReportFormSchema>) {
        ...
        const saveReport = {
            ...
            auditStatus: editRow?.auditStatus,
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="max-w-[60%] p-0 flex flex-col max-h-[90vh]">
                    ...
                    <DialogHeader className="pt-3 px-3">
                        <DialogTitle>Audit Evaluation Form</DialogTitle>
                    </DialogHeader>
                            ...
                            <form>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 mb-3">
                                    <div className="col-span-1 md:col-span-2">
                                        ...
                                        <div className="max-h-60 overflow-y-auto space-y-4 py-3 px-0.5">
                                                            ...
                                                            <FormControl>
                                                                <div className="relative">
                                                                    ...
                                                                    <div className="relative w-full">
                                                                        {/* Prefix number as absolutely positioned element */}
                                                                        <span className="absolute top-3 left-3 text-md select-none pointer-events-none">
                                                                            {index + 1}.
                                                                        </span>
                                                                        ...
                                                                        <Textarea
                                                                            ...
                                                                            className="min-h-[80px] pl-8 pt-3"
                                                                        />
                                ...
                                <div className={`col-span-1 md:col-span-3 h-20 ${errors.RECOMENDATION ? 'mb-12' : 'mb-10'}`}>
                                ...
                                <div className={`grid grid-cols-1 md:grid-cols-3 gap-3 ${complianceStatusValue === 'failed' && updateRow && 'mb-10'}`}>
                                    ...
                                    {complianceStatusValue === 'failed' && <FormComboboxInput items={severity} formControl={form.control} name={"SEVERITY"} placeholder={"Choose Severity level"} label={"Severity"} />}
                                    {complianceStatusValue === 'failed' && editRow?.auditStatus === 'failed' && (
                                        <>
                                            ...
                                            <div className='col-span-1 md:col-span-3 h-20 mb-10'>
