...
export default function StartDiscovery(){
    ...
    const addIpBacknetRef = useRef<HTMLButtonElement>(null)
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                    ...
                    <DialogContent className="sm:max-w-[1305px]">
                        ...
                        <div className="sm:max-w-[1255px]">
                            ...
                            <StartDiscoveryForm IpBacknetref={addIpBacknetRef} IpRangeref={addIpRangeRef} macDiscoveryRef={addRouterForMACDiscoveryRef} startDiscoveryRef={startDiscoveryRef} onClose={() => setOpen(false)}/>
                        </div>

                        <DialogFooter>
                            <IconTextButton type="button" onClick={() => {
                                addIpBacknetRef.current.click()
                            }} > <Plus />Add Backnet IP </IconTextButton>
                            <IconTextButton type="button" onClick={() => {
