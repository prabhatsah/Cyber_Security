...
interface DiscoveryContextProps {
    ...
    dataFetched:boolean,
    setDataFetched:(status:boolean) => void;
}
...
export const DiscoveryProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    return (
        <DiscoveryContext.Provider value={{ discoveryStarted, setDiscoveryStarted,discoveryProgress, setDiscoveryProgress,dataFetched,setDataFetched }}>
            {children}
