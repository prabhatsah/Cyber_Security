...
const StartDiscoveryForm = forwardRef<HTMLFormElement, StartDiscoveryFormProps>((props, ref) => {
    ...
    //using context
    const {setDataFetched} = useDiscovery()

    if(windowsDatafetched&&sshDatafetched&&snmpDatafetched)
        setDataFetched(true)
    else
            ...
            <form onSubmit={form.handleSubmit(startDiscovery)} >
                ...
                <div className="flex items-start justify-between gap-2">
                    ...
                    <Card className="p-2 w-1/3">
                        ...
                        <CardContent className="p-2 min-h-[100px] flex items-center">
                            {windowsDatafetched?<DataTable data={wincredData} columns={credentialTableColumns} extraParams={ext} />:<LoadingSpinner/>}
                        </CardContent>
                    ...
                    <Card className="p-2 w-1/3">
                        ...
                        <CardContent className="p-2 min-h-[100px] flex items-center">
                            {sshDatafetched?<DataTable data={sshcredData} columns={credentialTableColumns} extraParams={ext} />:<LoadingSpinner/>}
                        </CardContent>
                    ...
                    <Card className="p-2 w-1/3">
                        ...
                        <CardContent className="p-2 min-h-[100px] flex items-center">
                            {snmpDatafetched?<DataTable data={snmpcredData} columns={credentialTableColumns} extraParams={ext} />:<LoadingSpinner/>}
                        </CardContent>
