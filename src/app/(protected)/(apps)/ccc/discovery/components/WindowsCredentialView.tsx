        ...
        {deleteCredential &&
          <Alert cancelText="No"
            ...
            title={`Are you sure You want to delete ${deleteingCredential.credentialName} ?`} onConfirm={() => {
              ...
              toast({
                title:"Success",
                description: `${deleteingCredential.credentialName} deleted`,
                ...
                <div key={index} className="border rounded-md p-2 shadow-sm">
                  ...
                  <div className="flex items-end justify-between mb-2">
                    ...
                    <div className="flex justify-start items-center w-1/2 h-[38px]">
                      <IconTextButtonWithTooltip type="button" className="me-2 ms-2" tooltipContent="Delete Credential" onClick={() => {
                        debugger
                      ...
                      <Dialog>
                        <DialogTrigger asChild>
                          <IconTextButtonWithTooltip type="button" tooltipContent="User Access" onClick={() => {
                            debugger
