...
import ResourceModal from "./add-resource/AddResourceModalForm_old";
...
export default function ResourceComponent({ resourceData, projectIdentifier, userMaps }: { resourceData: ResourceData[]; projectIdentifier: string; userMaps: UserMaps }) {
  ...
  return (
    <div>
      <ResourceMainDataTable resourceData={resourceData} userMaps={userMaps} processedData={processedData} columnSchema={columnSchema} projectIdentifier={projectIdentifier}/>
    </div>
  );
}
