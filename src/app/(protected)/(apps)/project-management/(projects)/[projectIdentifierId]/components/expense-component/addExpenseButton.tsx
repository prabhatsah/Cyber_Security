...
export default function AddExpenseButton({ projectIdentifier,editInstData }: { projectIdentifier: string,editInstData:any }) {
    ...
    return (
        <>
            ...
            <ExpenseModal isOpen={isModalOpen} onClose={handleCloseModal} projectIdentifier={projectIdentifier} editInstData={editInstData}/>
        </>
    );
}
