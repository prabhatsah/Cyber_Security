...
function EmployeeDetailsDataTable({roleDatas,gradeDatas,filteredEmpTableData,empInsMetadata,uploadedEmployeeArray}:any) {
    ...
    const fetchEmpTableData = async () => {
        try {
            ...
            setGradeData(gradeDatas[0]?.data?.gradeDetails);
        } catch (error) {
