...
export default function IbmCloudConfigFormModal({
  ...
  serviceNameArray.forEach((eachPart) => {
    if (eachPart === "ibm") {
      serviceName += eachPart.toUpperCase() + " ";
    } else {
      serviceName +=
                ...
                <div className="flex-1 grow">
                  <div className="border-t border-tremor-border p-6 dark:border-dark-tremor-border md:border-none">
                    ...
                    border border-tremor-border p-1 dark:border-dark-tremor-border"
                      >
                        <RiCloudLine className="size-5" aria-hidden={true} />
                      </div>
                      <div>
                    ...
                    <p className="mt-1 text-tremor-default leading-6 text-tremor-content dark:text-dark-tremor-content">
                      IBM Cloud provides hybrid cloud solutions with computing,
                      AI, storage, and security services.
                    </p>
                    <h4 className="mt-6 text-tremor-default font-medium text-tremor-content-strong dark:text-dark-tremor-content-strong">
                      Supported functionality:
                    </h4>
                    <p className="mt-1 text-tremor-default leading-6 text-tremor-content dark:text-dark-tremor-content">
                      Supports computing, storage, AI, machine learning,
                      networking, security, and hybrid cloud solutions.
                    </p>
                  </div>
                </div>
