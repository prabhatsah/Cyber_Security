...
import { saveCommentData } from "../../../../../_utils/buyer/my-rfps/rfp-details-page/save-comment-data";
...
export default function CollaborationSection({ draftId }: { draftId: any }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (response.length > 0) {
        ...
        setChatMessages(data.chatMessages ? data.chatMessages : []);
      }
    };
  ...
  const handleSend = async () => {
    ...
    saveCommentData(draftId, newMessage);
  };
