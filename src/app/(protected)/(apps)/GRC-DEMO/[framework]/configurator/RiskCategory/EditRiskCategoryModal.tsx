...
export default function RiskCategoryEdit({ open, setOpen, riskCategoryData, }: { open: boolean; setOpen: React.Dispatch<React.SetStateAction<boolean>>; riskCategoryData: Record<string, string>[] }) {
    ...
    async function saveImpactDataToBackend() {
        ...
        const formattedData = categoryDataTableData.reduce((acc, curr) => {
            ...
            return acc;
        }, {} as Record<string, { riskCategoryId: string; riskCategory: string; }>);
        ...
        console.log('Saving impact data to backend:', formattedData);
