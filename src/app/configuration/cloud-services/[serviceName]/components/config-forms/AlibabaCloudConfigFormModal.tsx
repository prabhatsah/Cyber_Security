import { RiAlibabaCloudFill, RiCloseLine } from "@remixicon/react";
import { Dialog, DialogPanel, Divider } from "@tremor/react";

export default function AlibabaCloudConfigFormModal({
  serviceUrl,
  isFormModalOpen,
  onClose,
}: {
                ...
                <div className="flex-1 grow">
                  <div className="border-t border-tremor-border p-6 dark:border-dark-tremor-border md:border-none">
                    ...
                    <p className="mt-1 text-tremor-default leading-6 text-tremor-content dark:text-dark-tremor-content">
                      Alibaba Cloud provides scalable computing, storage, AI,
                      and security solutions for businesses.
                    </p>
                    <h4 className="mt-6 text-tremor-default font-medium text-tremor-content-strong dark:text-dark-tremor-content-strong">
                      Supported functionality:
                    </h4>
                    <p className="mt-1 text-tremor-default leading-6 text-tremor-content dark:text-dark-tremor-content">
                      Supports computing, storage, networking, AI, security, and
                      big data analytics.
                    </p>
                  </div>
                </div>
