import { RiCloseLine, RiCloudy2Line } from "@remixicon/react";
import { Dialog, DialogPanel, Divider } from "@tremor/react";

export default function OracleCloudConfigFormModal({
  serviceUrl,
  isFormModalOpen,
  onClose,
}: {
                ...
                <div className="flex-1 grow">
                  <div className="border-t border-tremor-border p-6 dark:border-dark-tremor-border md:border-none">
                    ...
                    border border-tremor-border p-1 dark:border-dark-tremor-border"
                      >
                        <RiCloudy2Line className="size-5" aria-hidden={true} />
                      </div>
                      <div>
                    ...
                    <p className="mt-1 text-tremor-default leading-6 text-tremor-content dark:text-dark-tremor-content">
                      Oracle Cloud Infrastructure (OCI) delivers
                      high-performance computing, storage, and security for
                      enterprises.
                    </p>
                    ...
                    <p className="mt-1 text-tremor-default leading-6 text-tremor-content dark:text-dark-tremor-content">
                      Supports computing, storage, networking, AI, security,
