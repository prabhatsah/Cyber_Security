...
export default function TrivyConfigWidget({
    ...
    containerUrl: string;
    eachConfigDetails: TrivyConfiguration;
}) {
    ...
    async function handleDeleteConfig(configId: string) {
        await deleteConfigWithKey("container_config", "configId", configId);
    };
                            ...
                            <div className="">
                                ...
                                <ul className="mt-2 space-y-1">
                                    <li className="truncate text-sm leading-6 text-tremor-content dark:text-dark-tremor-content">
                                        IP: <span title={eachConfigDetails.pythonServerIp} className="truncate text-widget-secondaryheader">{eachConfigDetails.pythonServerIp}</span>
                                    </li>

                                    <li className="truncate text-sm leading-6 text-tremor-content dark:text-dark-tremor-content">
                                        Port: <span title={eachConfigDetails.pythonServerPort} className="truncate text-widget-secondaryheader">{eachConfigDetails.pythonServerPort}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
