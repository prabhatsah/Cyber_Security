...
const EchartBarChartWithNegative: React.FC<EChartBarChartWithNegativeProps> = ({
  ...
  useEffect(() => {
    if (chartInstance) {
      ...
      const chartOption = {
        title: {
          text: configurationObj.title || "Negative Bar Chart",
          left: "center",
        },
        tooltip: {
          trigger: "axis",
        ...
        yAxis: [
          {
            ...
            data: configurationObj.categories, // Categories from props
          },
        ],
        ...
        series: Object.keys(chartData).map((category, index) => ({
          ...
          itemStyle: {
            color: configurationObj.colors?.[index] || "#000", // Set color from configuration
          },
        })),
