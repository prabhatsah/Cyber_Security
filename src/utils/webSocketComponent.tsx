...
const fetchReqScanNotificationDetails = async (scanId: string) => {
  const reqScanNotificationData = await fetchData("scandetails", "scan_id", [{ table: "scandetails", column: "scan_id", value: scanId }], null, null, false);
  console.log(reqScanNotificationData)
