...
const baseUrl = "https://ikoncloud-uat.keross.com/cyber-security"
 // process.env.NEXT_PUBLIC_BASE_PATH + '/cyber-security'||
  //`http://localhost:${process.env.NEXT_PUBLIC_PORT || 3000}/cyber-security`;
